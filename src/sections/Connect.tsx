...
export default function Connect() {
  ...
  return (
    <section id="connect" className="relative w-full py-20 md:py-28 bg-[#050505] border-t border-neutral-900 overflow-hidden">
          ...
          <div className="min-w-0 flex flex-col justify-between">
            <div>
              ...
              <p className="text-sm text-neutral-400 max-w-md font-light leading-relaxed mb-4 sm:mb-6">
                Have a project in mind, looking to hire a junior full-stack web developer, or simply want to chat about development systems? Get in touch and let&apos;s start the discussion.
              </p>
            </div>
